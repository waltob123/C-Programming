# Preprocessing
This stage of the compilation process in the C language takes a source file and expands all header files and macros defined inside the source file.
...
So from the code above the <stdio.h> gets expanded. What happens is the code in the header file <stdio.h> replaces the #include <stdio.h> line. This same thing happens to all macro files other header files.

So this is the result of the preprocessing stage.
...
NB: To stop the compilation at preprocessing stage we use the -E flag with the gcc command.
The extension of the output file is .i
#### Command
